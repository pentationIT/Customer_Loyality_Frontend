...
@Component({
  selector: 'app-ppcdata',
  templateUrl: './ppcdata.component.html',
  styleUrls: ['./ppcdata.component.css']
})
export class PpcdataComponent implements OnInit {
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    this.rest.ppcSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
        ...
        if(reportType=='summary'){
          ...
          this.monthColList = res.monthList
