...
@Component({
  selector: 'app-customerwaterfall',
  templateUrl: './customerwaterfall.component.html',
  styleUrls: ['./customerwaterfall.component.css']
})
export class CustomerwaterfallComponent implements OnInit {
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    this.rest.waterfallSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
        ...
        if(reportType=='summary'){
          ...
          this.prevmonthColList = res.prevmonthStrList;
          this.monthColList = res.monthStrList;

          // console.log("prev month >>>>>>>", this.prevmonthColList[this.prevmonthColList.length-1]);
          // console.log("prev month >>>>>>>", this.prevmonthColList);
