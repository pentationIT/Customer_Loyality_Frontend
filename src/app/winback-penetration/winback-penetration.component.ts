...
@Component({
  selector: 'app-winback-penetration',
  templateUrl: './winback-penetration.component.html',
  styleUrls: ['./winback-penetration.component.css']
})
export class WinbackPenetrationComponent implements OnInit {
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    this.rest.winback_penetrationSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
      ...
      //   this.summary_filteredResult = res.finalData
        ...
        if(reportType=='summary'){
          this.summary_filteredResult = res.finalData
          console.log("summary_filteredResult1---->", this.summary_filteredResult)
          ...
          // this.summary_filteredResult = res.finalData // for now
          // console.log("summary_filteredResult2---->", this.summary_filteredResult)
          ...
          this.details_keyColcount = res.finalColumns.length
          this.reportStart = res.startTime
          this.reportEnd = res.endTime
          this.reportDuration = res.duration
