...
@Component({
  selector: 'app-winback-opportunity',
  templateUrl: './winback-opportunity.component.html',
  styleUrls: ['./winback-opportunity.component.css']
})
export class WinbackOpportunityComponent implements OnInit {
  ...
  expYear_dropdownList = [] as any;
  expYear_selectedItems = [] as any;
  expYear_dropdownSettings:IDropdownSettings = {} as any
  ...
  businessType_dropdownList = [{businessType:'NEW BUSINESS'},{businessType:'RENEWAL'},{businessType:'ROllOVER'},] as any;
  ...
  saveFileImd(event:any){
    ...
    this.rest.saveFilewinbackOpp(fd).subscribe((res: any) => {
      if (res.success) {        
  ...
  getExpYearList():any {  
    ...
    this.rest.getExpYearList().subscribe((res: any) => {
      if (res.success) {        
        this.expYear_dropdownList = res.expYearList;
        // return this.zone_dropdownList
      } else {
      }
    });
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    const data_pen = {
      ...
      expYear: this.expYear_selectedItems,
    ...
    this.rest.winbackOppSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
        ...
        if(reportType=='summary'){
          ...
          this.monthYearList = res.monthList;
  ...
  downloadPolicyWiseReport(){
    ...
    this.rest.downloadPolicyWiseReport_winback(data_pen).subscribe((res: any) => {
      if (res.success) {  
