...
@Component({
  selector: 'app-bucketmovement',
  templateUrl: './bucketmovement.component.html',
  styleUrls: ['./bucketmovement.component.css']
})
export class BucketmovementComponent implements OnInit {
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    this.rest.bucketmovementSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
