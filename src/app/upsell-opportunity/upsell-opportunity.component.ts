...
@Component({
  selector: 'app-upsell-opportunity',
  templateUrl: './upsell-opportunity.component.html',
  styleUrls: ['./upsell-opportunity.component.css']
})
export class UpsellOpportunityComponent implements OnInit {
  ...
  saveFileImd(event:any){
    ...
    this.rest.saveFileUpsellOpp(fd).subscribe((res: any) => {
      if (res.success) {        
  ...
  getFilteredResult(reportType: any, isdownload:any, firstCall:any){
    ...
    this.rest.upsellOppSummaryReport(data_pen).subscribe((res: any) => {
      if (res.success) {  
  ...
  downloadPolicyWiseReport(){
    ...
    this.rest.downloadPolicyWiseReport_upsell(data_pen).subscribe((res: any) => {
      if (res.success) {  
